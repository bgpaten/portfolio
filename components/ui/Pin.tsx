...
export const PinContainer = ({
  ...
  // Handle mouse enter and leave events for animations
  const onMouseEnter = () => {
      ...
      <div className="w-full h-full -mt-7 flex-none inset-0">
        <div className="absolute top-0 inset-x-0 flex justify-center">
          <a
            ...
            className="relative z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 flex items-center space-x-2"
          >
            {/* Tanggal akan tetap sejajar */}
            <span className="relative z-20 text-white text-xs font-bold inline-block whitespace-nowrap">
              {title}
            </span>
